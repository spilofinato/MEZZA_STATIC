...
function shuffleCarouselItemsPosition() {
	...
	let aCarouselItems = document.querySelectorAll(".carousel-item");
...
function shuffleAndAddGalleryItems() {
    ...
    let aAllImagesInCarousel = document.querySelectorAll(".carousel-item > img");
    let aAllVideosInCarousel = document.querySelectorAll(".carousel-item > video");
